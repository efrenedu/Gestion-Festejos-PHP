...
<head>
	...
	<title>Consultar Productos Alquilados </title>
...
<div  id="content2">
  <h2 id="title1">Consultar Productos Alquilados</h2>
  <form  method="post">
    <label >Filtro:</label>
    <select id="filtro" size='1' onchange="activar_filtro_consultas()">
      <option value="">Elegir</option>
      <option value="nombre_producto">Por Producto</option>
      <option value="formato">Por Formato</option>
      <option value="CI_cliente">Por Cliente</option>
...
/*Verify no Exist Illegal Access from User*/
  ...
  echo "</table></div><br>";
?>
    <input type="button" value="Consultar" onclick="consultar_productosAlquilados()" class="boton_login">
    <input style="margin-left:2%" type="button" value="Generar Reporte" onclick="Pdf_Consults('Rent_Products')" class="boton_login">
  </form>
